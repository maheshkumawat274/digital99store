...
const TrendingSection:React.FC<TrendingProps> = ({ onNav, onAddToCart, onToggleWishlist, wishlist })  => {
  return (
    <>
     <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            ...
            <Button variant="outline" onClick={() => onNav('trending-products')}>Explore More</Button>
          </div>
